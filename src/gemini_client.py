...
"""
    ...
    try:
        ...
        print(f"--- 끝 ---")
        return {
            "cover": {"company_name": "(파싱 실패)", "subtitle": "오류", "prepared_for": "-", "prepared_by": "venturecompany", "date": "-"},
            "meta_table": [],
            "sections": [{"eyebrow": "ERROR", "title": "보고서 생성 실패", "intro": "JSON 파싱 실패", "components": [{"type": "paragraph", "text": raw[:3000]}]}],
            "closing": None
        }
